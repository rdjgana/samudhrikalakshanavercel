...
import RSMSalaryExpenses from "./pages/rsm/RSMSalaryExpenses";
            ...
            <MainLayout>
              <Routes>
                ...
                <Route
                  ...
                  element={<Navigate to="/hr/reports?tab=shopwise-stock" replace />}
                />
                <Route
                ...
                <Route
                  path="/manpower"
                  element={<Navigate to="/orders?tab=manpower" replace />}
                />
                <Route path="/claims" element={<Claims />} />
                <Route path="/reports" element={<Reports />} />
                <Route path="/approvals" element={<Approvals />} />
                <Route path="/rsm/salary-expenses" element={<RSMSalaryExpenses />} />
