...
import SupervisorPromoterSalesReport from "../../components/reports/SupervisorPromoterSalesReport";
...
import {
  ...
  MOCK_INCENTIVES_REPORT_SUPERVISOR_SCOPE,
  MOCK_SALARY_REPORT,
  MOCK_SALARY_REPORT_SUPERVISOR_SCOPE,
  MOCK_EXPENSES_REPORT,
  MOCK_EXPENSES_REPORT_SUPERVISOR_SCOPE,
...
const Reports = () => {
  ...
  const handleGenerateIncentives = () => {
    ...
    setIncentivesData(
      isSupervisor ? MOCK_INCENTIVES_REPORT_SUPERVISOR_SCOPE : MOCK_INCENTIVES_REPORT,
    );
  };
  ...
  const handleGenerateSalary = () => {
    ...
    setSalaryData(
      isSupervisor ? MOCK_SALARY_REPORT_SUPERVISOR_SCOPE : MOCK_SALARY_REPORT,
    );
  };
  ...
  const handleGenerateExpenses = () => {
    ...
    setExpensesData(
      isSupervisor ? MOCK_EXPENSES_REPORT_SUPERVISOR_SCOPE : MOCK_EXPENSES_REPORT,
    );
  };
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="target-vs-sales" className="w-full">
        <TabsList className="grid w-full grid-cols-6">
          <TabsTrigger value="target-vs-sales">Sales</TabsTrigger>
        ...
        <TabsContent value="target-vs-sales">
          {isSupervisor ? (
            <SupervisorPromoterSalesReport />
          ) : (
          <Card>
            <CardHeader>
              <CardTitle>Sales report</CardTitle>
              <CardDescription>
                View sales performance with Consolidated,
        ...
        <TabsContent value="attendance">
          <SupervisorDailyAttendanceReport
            audience={isSupervisor ? "supervisor" : "hr"}
          />
        </TabsContent>
        ...
        <TabsContent value="incentives">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {isSupervisor
                  ? "Incentives for distributors, promoters, and shops only"
        ...
        <TabsContent value="salary">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {isSupervisor
                  ? "Salary summary for distributors, promoters, and shops only"
                  : "Category-wise salary report"}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4 p-4 border rounded-lg bg-gray-50">
        ...
        <TabsContent value="expenses">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {isSupervisor
                  ? "Expense claims for distributors, promoters, and shops only"
        ...
        <TabsContent value="new-shops">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {isSupervisor
                  ? "Shop activation tracking (shops report) for your territory"
                  : "New shops activation tracking with work plan date"}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4 p-4 border rounded-lg bg-gray-50">
