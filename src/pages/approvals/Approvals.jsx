        ...
        <TabsContent value="work-plan">
          <Card>
            <CardHeader>
              ...
              <CardDescription>ASM, SO, Supervisor, and BDM work plan requests</CardDescription>
            </CardHeader>
            <CardContent>
              {/* Work Plan Filters */}
                            ...
                            <TableCell>
                              <div className="flex gap-2">
                                ...
                                <Button
                                  size="sm"
                                  variant="outline"
                                  onClick={() => handleAction(approval, 'modify', 'work-plan')}
                                >
                                  Modify
                                </Button>
                                <Button
                      ...
                      <TableCell>
                        <div className="flex gap-2">
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => handleAction(approval, 'modify', 'target')}
                          >
                            Modify
                          </Button>
                          <Button
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              ...
              {actionType === 'modify' && 'Modify'} Request
            </DialogTitle>
          </DialogHeader>
