...
const PromoterSalesReturn = () => {
  ...
  const isOtherReason = returnReason === 'Other'
  ...
  const handleSubmit = () => {
    ...
    if (isOtherReason && !trimmedOtherReason) {
    ...
    const finalReason = isOtherReason ? `Other: ${trimmedOtherReason}` : returnReason
                ...
                {selectedProduct && (
                  <>
                    ...
                    <Button
                      ...
                      disabled={
                        !returnReason ||
                        (isOtherReason && !trimmedOtherReason) ||
                        !batchNumber ||
                        !manufacturingMonth ||
                        !productPhoto
                      }
