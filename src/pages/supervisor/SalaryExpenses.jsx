    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Fixed salary and allowances</CardDescription>
        </CardHeader>
          ...
          <div className="border-t pt-4">
            <div className="flex items-center justify-between">
              ...
              <p className="text-2xl font-bold text-[#433228]">
                ₹{(supervisorSalary.fixedSalary + supervisorSalary.fixedTA + daAmount).toLocaleString('en-IN')}
              </p>
            </div>
          </div>
      ...
      <Dialog open={showDiscrepancyDialog} onOpenChange={setShowDiscrepancyDialog}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            {discrepancyType === 'Others' && (
              <div className="space-y-2">
                <Label htmlFor="discrepancy-other-type">Specify Discrepancy Type *</Label>
                <Input
                  id="discrepancy-other-type"
                  type="text"
