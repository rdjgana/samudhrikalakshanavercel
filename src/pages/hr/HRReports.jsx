...
import { FileText, Download, CheckCircle, Edit, Eye, Play, Pause, Headphones } from 'lucide-react'
import SupervisorPromoterSalesReport from '../../components/reports/SupervisorPromoterSalesReport'
import HRConsolidatedSalesReport from '../../components/reports/HRConsolidatedSalesReport'
import SupervisorDailyAttendanceReport from '../../components/reports/SupervisorDailyAttendanceReport'
import HRShopwiseOverallSalesTrackerSkuWise from './HRShopwiseOverallSalesTrackerSkuWise'
...
const HRReports = () => {
  ...
  const defaultTab = HR_REPORT_TABS.includes(tabFromUrl) ? tabFromUrl : 'sales'
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Sales and attendance from workbook templates, consolidated sales, shopwise SKU tracker, and daily activity
        </p>
      </div>
      ...
      <Tabs key={defaultTab} defaultValue={defaultTab} className="w-full">
        <TabsList className="flex flex-wrap h-auto gap-1 p-1">
          ...
          <TabsTrigger value="consolidated-sales">Consolidated Sales Report</TabsTrigger>
          <TabsTrigger value="shopwise-stock">Shopwise Stock Report</TabsTrigger>
          <TabsTrigger value="activity">Daily Activity Report</TabsTrigger>
        </TabsList>

        <TabsContent value="sales">
          <SupervisorPromoterSalesReport audience="hr" />
        </TabsContent>
        ...
        <TabsContent value="consolidated-sales">
          <HRConsolidatedSalesReport />
        </TabsContent>
        ...
        <TabsContent value="shopwise-stock" className="mt-4">
          <HRShopwiseOverallSalesTrackerSkuWise embedded />
        </TabsContent>
      </Tabs>
