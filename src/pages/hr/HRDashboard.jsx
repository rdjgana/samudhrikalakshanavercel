  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Overview of sales performance and team status</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          <CardHeader>
            <CardTitle>Yesterday — Primary Achieved</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Yesterday — Secondary Achieved</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      {/* Current Month Target Achievement — primary / secondary tabs */}
      <Card className="border-0 shadow-sm">
        <CardHeader className="pb-3">
          <CardTitle className="text-lg font-semibold">Current Month Target Achievement</CardTitle>
          <CardDescription className="text-sm">
            Review primary and secondary month-end pending value, percentages, and MRP.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <TabsContent key={tab.value} value={tab.value} className="space-y-6">
                <div className="rounded-xl border bg-gray-50 p-5">
                  ...
                  <p className="mt-2 text-sm text-gray-600">
                    Need to achieve at the {tab.levelLabelDisplay} level:{' '}
