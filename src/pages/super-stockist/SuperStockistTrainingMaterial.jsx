...
const MOCK_CATALOGUE = [
  { id: 1, name: 'Product Catalogue 2024', type: 'PDF', size: '2.5 MB', url: '#' },
  { id: 2, name: 'Face Care Products', type: 'PDF', size: '1.8 MB', url: '#' },
  { id: 3, name: 'Body Care Products', type: 'PDF', size: '1.5 MB', url: '#' },
  { id: 4, name: 'Hair Care Products', type: 'PDF', size: '1.9 MB', url: '#' },
  { id: 5, name: 'Personal Care Products', type: 'PDF', size: '1.6 MB', url: '#' },
]

// Mock Pantos (Training Documents) Data
const MOCK_PANTOS = [
  { id: 1, name: 'Sales Training Guide', type: 'PDF', size: '3.2 MB', url: '#' },
  { id: 2, name: 'Product Knowledge Manual', type: 'PDF', size: '2.1 MB', url: '#' },
  { id: 3, name: 'Customer Service Guide', type: 'PDF', size: '1.9 MB', url: '#' },
  { id: 4, name: 'Inventory Management Guide', type: 'PDF', size: '2.5 MB', url: '#' },
  { id: 5, name: 'Order Processing Manual', type: 'PDF', size: '2.3 MB', url: '#' },
]
...
const MOCK_VIDEOS = [
  ...
  { id: 4, name: 'Stock Management Best Practices', duration: '18:15', thumbnail: '#' },
  { id: 5, name: 'Order Fulfillment Process', duration: '14:30', thumbnail: '#' },
]

const SuperStockistTrainingMaterial = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Access training materials, catalogues, and videos</p>
      </div>
                ...
                {MOCK_CATALOGUE.map((item) => (
                  <div key={item.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="bg-[#433228] hover:bg-[#5a4238] text-white border-[#433228]"
                    >
        ...
        <TabsContent value="pantos">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Download training materials and guides</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                  ...
                  <div key={video.id} className="border rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div className="p-4">
                      ...
                      <Button
                        ...
                        className="w-full mt-3 bg-[#433228] hover:bg-[#5a4238] text-white"
                      >
...
export default SuperStockistTrainingMaterial
