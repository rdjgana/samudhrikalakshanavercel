...
export const MOCK_PROMOTER_TARGETS = {
  ...
  secondaryTarget: {
    target: 180000, // MRP (Maximum Achievable Price) target
    achieved: 142000,
    balance: 38000,
    percentage: 78.89,
  },
...
export const MOCK_HIERARCHY = {
  ...
  distributors: [
    { id: 1, name: 'Beauty Distributors Chennai', code: 'DIST001', supervisorId: 1, district: 'Chennai', shopCount: 25, ssId: 1 },
    { id: 2, name: 'Cosmetic Solutions Pvt Ltd', code: 'DIST002', supervisorId: 1, district: 'Chennai', shopCount: 18, ssId: 1 },
    { id: 3, name: 'Glow Distributors', code: 'DIST003', supervisorId: 2, district: 'Chennai', shopCount: 22, ssId: 1 },
    { id: 4, name: 'Radiance Wholesale', code: 'DIST004', supervisorId: 3, district: 'Tiruvallur', shopCount: 15, ssId: 1 },
    { id: 5, name: 'Beauty World Distributors', code: 'DIST005', supervisorId: 4, district: 'Madurai', shopCount: 20, ssId: 3 },
    { id: 6, name: 'Cosmetic Hub', code: 'DIST006', supervisorId: 5, district: 'Tirunelveli', shopCount: 12, ssId: 3 },
    { id: 7, name: 'Glow Enterprises', code: 'DIST007', supervisorId: 6, district: 'Coimbatore', shopCount: 28, ssId: 2 },
  ],
  promoters: [
...
export const MOCK_WORK_PLAN_APPROVALS = [
  // ASM Work Plans
  { id: 1, employeeName: 'Rajesh Kumar', role: 'ASM', category: 'ASM', date: '2024-01-20', status: 'Pending' },
  { id: 2, employeeName: 'Priya Menon', role: 'ASM', category: 'ASM', date: '2024-01-21', status: 'Pending' },
  { id: 3, employeeName: 'Suresh Iyer', role: 'ASM', category: 'ASM', date: '2024-01-22', status: 'Pending' },
  { id: 4, employeeName: 'Lakshmi Devi', role: 'ASM', category: 'ASM', date: '2024-01-23', status: 'Pending' },

  // SO Work Plans
  { id: 5, employeeName: 'Arun Balaji', role: 'SO', category: 'SO', date: '2024-01-20', status: 'Pending' },
  { id: 6, employeeName: 'Divya Ramesh', role: 'SO', category: 'SO', date: '2024-01-21', status: 'Pending' },
  { id: 7, employeeName: 'Karthik Senthil', role: 'SO', category: 'SO', date: '2024-01-22', status: 'Pending' },
  { id: 8, employeeName: 'Meera Krishnan', role: 'SO', category: 'SO', date: '2024-01-23', status: 'Pending' },
  { id: 9, employeeName: 'Vikram Reddy', role: 'SO', category: 'SO', date: '2024-01-24', status: 'Pending' },

  // Supervisor Work Plans
  { id: 10, employeeName: 'Mohan Raj', role: 'Supervisor', category: 'Supervisor', date: '2024-01-20', status: 'Pending' },
  { id: 11, employeeName: 'Geetha Lakshmi', role: 'Supervisor', category: 'Supervisor', date: '2024-01-21', status: 'Pending' },
  { id: 12, employeeName: 'Ravi Shankar', role: 'Supervisor', category: 'Supervisor', date: '2024-01-22', status: 'Pending' },
  { id: 13, employeeName: 'Saranya Venkat', role: 'Supervisor', category: 'Supervisor', date: '2024-01-23', status: 'Pending' },
  { id: 14, employeeName: 'Ganesh Kumar', role: 'Supervisor', category: 'Supervisor', date: '2024-01-24', status: 'Pending' },

  // BDM Work Plans
  { id: 15, employeeName: 'Ravi Shankar', role: 'BDM', category: 'BDM', date: '2024-01-20', status: 'Pending' },
  { id: 16, employeeName: 'Deepa Suresh', role: 'BDM', category: 'BDM', date: '2024-01-21', status: 'Pending' },
  { id: 17, employeeName: 'Karthik Iyer', role: 'BDM', category: 'BDM', date: '2024-01-22', status: 'Pending' },
  { id: 18, employeeName: 'Priya Nair', role: 'BDM', category: 'BDM', date: '2024-01-23', status: 'Pending' },
]
...
export const MOCK_ATTENDANCE_REPORT = [
  { employee: 'Rajesh Kumar', role: 'ASM', weekOff: 4, daysPresent: 23, daysAbsent: 2, totalDays: 25, attendancePercentage: 92 },
  { employee: 'Priya Menon', role: 'ASM', weekOff: 4, daysPresent: 23, daysAbsent: 2, totalDays: 25, attendancePercentage: 92 },
  { employee: 'Arun Balaji', role: 'SO', weekOff: 4, daysPresent: 22, daysAbsent: 3, totalDays: 25, attendancePercentage: 88 },
  { employee: 'Divya Ramesh', role: 'SO', weekOff: 4, daysPresent: 22, daysAbsent: 3, totalDays: 25, attendancePercentage: 88 },
  { employee: 'Kavitha Rani', role: 'Promoter', weekOff: 4, daysPresent: 24, daysAbsent: 1, totalDays: 25, attendancePercentage: 96 },
  { employee: 'Selvi Murugan', role: 'Promoter', weekOff: 4, daysPresent: 22, daysAbsent: 3, totalDays: 25, attendancePercentage: 88 },
  { employee: 'Malathi Devi', role: 'Promoter', weekOff: 4, daysPresent: 21, daysAbsent: 4, totalDays: 25, attendancePercentage: 84 },
  { employee: 'Senthil Kumar', role: 'Distributor', weekOff: 4, daysPresent: 25, daysAbsent: 0, totalDays: 25, attendancePercentage: 100 },
  { employee: 'Lakshmi Traders', role: 'Distributor', weekOff: 4, daysPresent: 24, daysAbsent: 1, totalDays: 25, attendancePercentage: 96 },
  { employee: 'Murugan Agencies', role: 'Distributor', weekOff: 4, daysPresent: 23, daysAbsent: 2, totalDays: 25, attendancePercentage: 92 },
]
...
/** KPI Reports (Incentives / Salary / Expenses): supervisor scope — Distributor, Promoter, Shops only */
export const MOCK_INCENTIVES_REPORT_SUPERVISOR_SCOPE = [
  {
    category: 'Distributor',
    targetAchieved: 88,
    incentiveAmount: 120000,
    bonusAmount: 35000,
    totalIncentive: 155000,
    employeesEligible: 6,
  },
  {
    category: 'Promoter',
    ...
    bonusAmount: 22000,
    totalIncentive: 117000,
    employeesEligible: 18,
  },
  {
    category: 'Shops',
    targetAchieved: 79,
...
export const MOCK_SALARY_REPORT_SUPERVISOR_SCOPE = [
  {
    category: 'Distributor',
    totalEmployees: 6,
    totalSalary: 4200000,
...
export const MOCK_EXPENSES_REPORT_SUPERVISOR_SCOPE = [
  {
    category: 'Distributor',
    totalClaims: 24,
...
export const MOCK_SUPERVISOR_DASHBOARD = {
  ...
  targetStatus: {
    assignedTargetAmount: 300000,
    completedTargetAmount: 210000,
    pendingTargetAmount: 90000,
  },
  performance: {
    ...
    purchaseChange: 8.5,
    salesChange: 12.3,
    /** Month-wise as-on-date primary and secondary sales (₹). Keys are YYYY-MM. */
    monthlyAsOnDateSales: {
      '2025-12': { primary: 1185000, secondary: 945000 },
      '2026-01': { primary: 1240000, secondary: 985000 },
      '2026-02': { primary: 1190000, secondary: 960000 },
      '2026-03': { primary: 1320000, secondary: 1040000 },
      '2026-04': { primary: 1410000, secondary: 1125000 },
      '2026-05': { primary: 1525000, secondary: 1208000 },
    },
  },
  promoters: [
